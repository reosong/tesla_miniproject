...
<input type="hidden" name="model" value="Model Y">
        ...
        <div class="size1">
            ...
            <input type="radio" name="moter" value="Long Range" id="1"><label for="1">Long Range</label>
            <input type="radio" name="moter" value="Performance" id="2"><label for="2">Performance</label> 
