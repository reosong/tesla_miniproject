...
<input type="hidden" name="model" value="Model 3">
        <!--모델명 -->
        <div class="size1">
            
            <input type="radio" name="moter" value="Standard Range" id="1"><label for="1">Standard Range</label>
            <input type="radio" name="moter" value="Long Range" id="2"><label for="2">Long Range</label> <br>
           <input type="radio" name="moter" value="Performance" id="3"><label for="3">Performance</label> 
